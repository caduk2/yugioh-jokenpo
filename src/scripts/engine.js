const state ={
    ...
    fieldCards:{
        players: document.getElementById("player-field-card"),
...
async function setCardsField(cardId) {
    ...
    state.fieldCards.players.style.display = "block";
    state.fieldCards.computer.style.display = "block";

    state.fieldCards.players.src = cardData[cardId].img;
...
async function resetDuel() {
    ...
    state.fieldCards.players.style.display = "none"
